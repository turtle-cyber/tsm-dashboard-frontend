...
export function AlertsDataGrid({ onAlertSelect, selectedAlertId }: AlertsDataGridProps) {
  ...
  const isSomeSelected = selectedAlerts.length > 0 && selectedAlerts.length < alertsTableData.length;
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Select value={timeRange} onValueChange={setTimeRange}>
              ...
              <SelectContent>
                <SelectItem value="default">Dec 2, 2024 12:00 AM - Dec 3, 2024 12:00 AM</SelectItem>
        ...
        <Table>
          ...
          <TableHead className="w-12">
                <Checkbox
                  ...
                  className={isSomeSelected ? "data-[state=indeterminate]:bg-primary data-[state=indeterminate]:border-primary" : ""}
                />
              </TableHead>
            ...
            {alertsTableData.map((alert) => (
              <TableRow
                ...
                className={`cursor-pointer transition-colors ${
                  selectedAlertId === alert.id ? "bg-primary/5 border-l-2 border-l-primary" : "hover:bg-muted/50"
                }`}
