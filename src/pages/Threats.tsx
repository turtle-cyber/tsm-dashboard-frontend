...
import { Shield, Clock, Users, Building, Eye, FileText, TrendingUp, ExternalLink, Download, Share2 } from "lucide-react";
...
import { mockThreatData, mitreFrequencyData, type ThreatData } from "@/data/mockThreatData";
...
const getConfidenceColor = (confidence: string) => {
  switch (confidence) {
    ...
    case 'suspicious': return 'text-purple-400 bg-purple-400/10';
    default: return 'text-muted-foreground bg-muted/10';
  }
};
...
const getVerdictColor = (verdict: string) => {
  switch (verdict) {
    case 'true_positive': return 'text-red-400 bg-red-400/10';
    case 'false_positive': return 'text-green-400 bg-green-400/10';
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Threat Details</h1>
            <p className="text-muted-foreground">Malware incident analysis and mitigation</p>
          </div>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <Badge className={cn("mt-1", getStatusColor(threat.threatStatus))}>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <Badge className={cn("mt-1", getConfidenceColor(threat.aiConfidence))}>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <Badge className={cn("mt-1", getVerdictColor(threat.analystVerdict))}>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <Badge className={cn("mt-1", getIncidentColor(threat.incidentStatus))}>
        ...
        <CardContent>
          <div className="grid grid-cols-4 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-400">{threat.mitigationActions.killed}</div>
              <div className="text-sm text-muted-foreground">KILLED ✓</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-400">{threat.mitigationActions.quarantined}</div>
              <div className="text-sm text-muted-foreground">QUARANTINED ✓</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-400">{threat.mitigationActions.remediated}</div>
              <div className="text-sm text-muted-foreground">REMEDIATED ✓</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-400">{threat.mitigationActions.rolledBack}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Endpoints affected</p>
                <p className="font-medium">{threat.endpointsAffected} times on {threat.endpointsAffected} endpoint</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Coverage</p>
                <p className="font-medium">{threat.accountsAffected} Account / {threat.sitesAffected} Site / {threat.groupsAffected} Group</p>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-sm font-medium">Find this hash on Deep Visibility</span>
            ...
            <div>
              <p className="text-sm text-muted-foreground mb-2">THREAT FILE NAME</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Latest MITRE Technique Hits</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="indicators">Threat Indicators ({threat.threatIndicators.length})</TabsTrigger>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Table>
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="font-mono text-xs">{threat.details.path}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-muted-foreground">Command Line Arguments</TableCell>
                      <TableCell className="font-mono text-xs">{threat.details.commandLine}</TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="font-mono text-xs">{threat.details.sha1}</TableCell>
                    </TableRow>
                    <TableRow>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-sm text-muted-foreground">At detection time:</p>
                  </div>
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono text-xs">{threat.endpoint.uuid}</span>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-xs">{threat.endpoint.fullDiskScan}</span>
                    </div>
                    <div className="flex justify-between">
